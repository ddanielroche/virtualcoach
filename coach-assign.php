...
/**
 * lists all users enrolled in a course with their assigned coach.
 *
...
$PAGE->set_title("$course->shortname: ".get_string('coach_assignment', 'virtualcoach'));
$PAGE->set_heading($course->fullname . ': ' . get_string('coach_assignment', 'virtualcoach'));
...
// TODO Render the unified filter.
/* = $PAGE->get_renderer('core_user');
